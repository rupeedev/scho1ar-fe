...
interface AccountTutorialDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const AccountTutorialDialog: React.FC<AccountTutorialDialogProps> = ({ open, onOpenChange }) => {
...
export default AccountTutorialDialog;
