    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button 
            className="border-none shadow-lg transition-all duration-300 hover:scale-105 bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 text-white hover:from-emerald-600 hover:via-green-600 hover:to-teal-600 rounded-xl px-6 py-3"
      ...
      <div className="flex gap-3 mb-6">
        <Select value={roleFilter} onValueChange={(value: string) => setRoleFilter(value as UserRole | '')}>
        ...
        <Select value={statusFilter} onValueChange={(value: string) => setStatusFilter(value as UserStatus | '')}>
          <SelectTrigger className="w-32 border border-gray-200 rounded-xl focus:ring-blue-500 focus:ring-2 transition-all duration-200">
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-b border-gray-50">
                  <TableHead className="w-[250px] text-xs font-semibold text-gray-900 uppercase tracking-wider py-4 px-6">User</TableHead>
                  <TableHead className="text-center text-xs font-semibold text-gray-900 uppercase tracking-wider py-4 px-6">Role</TableHead>
                  <TableHead className="text-center text-xs font-semibold text-gray-900 uppercase tracking-wider py-4 px-6">Status</TableHead>
                  <TableHead className="text-xs font-semibold text-gray-900 uppercase tracking-wider py-4 px-6">Last Active</TableHead>
                  <TableHead className="text-xs font-semibold text-gray-900 uppercase tracking-wider py-4 px-6">Joined</TableHead>
                  ...
                  <TableRow key={user.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors duration-150">
                    <TableCell className="py-4 px-6">
                      <div className="flex items-center">
                        ...
                        <div>
                          <span className="font-medium text-gray-900">{user.display_name || user.email}</span>
                          {user.display_name && (
                    ...
                    <TableCell className="py-4 px-6">
                      <div className="text-sm text-gray-900">{formatLastActive(user.last_active_at)}</div>
                    </TableCell>
                    <TableCell className="py-4 px-6">
      ...
      <DialogContent className="sm:max-w-md rounded-2xl border-gray-200 shadow-lg">
        <DialogHeader className="p-6 pb-4">
          ...
          <DialogDescription className="text-gray-600 font-normal">
            Add a new user to your organization and send them an invitation.
          </DialogDescription>
        </DialogHeader>
        <div className="px-6 pb-2">
          <div className="space-y-6">
                ...
                <SelectContent className="rounded-xl border-gray-200 shadow-lg">
                  <SelectItem value="admin" className="rounded-lg">
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-gray-500">Full access to organization settings</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="member" className="rounded-lg">
                    <div className="flex flex-col">
                      <span className="font-medium text-gray-900">Member</span>
                      <span className="text-sm text-gray-500">Can manage resources and view reports</span>
                    </div>
                  </SelectItem>
                  <SelectItem value="viewer" className="rounded-lg">
                    <div className="flex flex-col">
                      <span className="font-medium text-gray-900">Viewer</span>
                      <span className="text-sm text-gray-500">Can only view data and reports</span>
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="send-invitation" className="text-sm text-gray-900">
      ...
      <AlertDialogContent className="rounded-2xl border-gray-200 shadow-lg">
        <AlertDialogHeader className="p-6 pb-4">
          ...
          <AlertDialogDescription className="text-gray-600 font-normal">
            Are you sure you want to delete "{userToDelete?.display_name || userToDelete?.email}"? This action cannot be undone and will remove all their access to the organization.
          </AlertDialogDescription>
        </AlertDialogHeader>
    ...
    <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
      <DialogContent className="sm:max-w-md rounded-2xl border-gray-200 shadow-lg">
        ...
        <div className="px-6 pb-2">
          <div className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="edit-user-name" className="block text-sm font-medium text-gray-900">
                Display Name
              </label>
              <Input
                id="edit-user-name"
            ...
            <div className="space-y-2">
              <label htmlFor="edit-user-role" className="block text-sm font-medium text-gray-900">
                Role <span className="text-red-500">*</span>
              </label>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <label htmlFor="edit-user-active" className="text-sm text-gray-900">
                Active user
              </label>
            </div>
          </div>
